// This script initializes the Firebase database with sample resources
...
const initializeResources = async () => {
  console.log('Starting resources initialization...');
  ...
  try {
    ...
    console.log('Resources initialization completed successfully!');
    return results;
  } catch (error) {
